...
namespace aiko
{
    namespace physics
    {
        ...
        void Physics::input(sf::Event evnt)
        {
            ...
            {
                b2Vec2 mousePos = PhysicsUtils::sfVecToB2Vec(sf::Mouse::getPosition(*m_window));
        ...
        void Physics::boundWord(sf::RenderWindow& window)
        {
            ...
            auto size = PhysicsUtils::sfVecToB2Vec(window.getSize());
            auto post = PhysicsUtils::sfVecToB2Vec(window.getPosition());
